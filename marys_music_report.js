...
//
//fieldsets=RICH_CONTENT&categoryIds=bfc3b900-ee7c-4ee0-9d48-76a5114f5a84",
//

//
// fetch news items, and check wehen they were last updated
//
        fetch("https://www.wixapis.com/blog/v3/posts?fieldsets=RICH_CONTENT&categoryIds=bfc3b900-ee7c-4ee0-9d48-76a5114f5a84", fetchOptions)
        .then( (httpResponse) => {
                ...
                .then((response) => {
                    response.posts.forEach(post => {
                        ...
                        if (date > expires){
                            ...
                            console.log(post.title, date, post);
                        }
                    })
                    return response;
                })
